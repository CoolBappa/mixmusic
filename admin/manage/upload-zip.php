...
$file = fopen($url,"rb");
if($file){
$directory = "../../files/bulk_upload/"; // Directory to upload files to.
$valid_exts = array("zip"); // valid extensions
...
echo '<a class="btn btn-info" href="index.php">Upload Another</a> <a class="btn btn-success" href="zipupload.php?id='.$id.'">Next Step</a>';
