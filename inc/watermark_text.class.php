...
class Zubrag_watermark {
    ...
    function ApplyWatermark($text='', $color='', $angle=0, $offset_x=0, $offset_y=0, $opacity=0) {
        ...
        if ($this->image != "") {
            ...
            $ttfsize = imagettfbbox($this->font_size, $this->angle, $this->opacity, $this->font, $this->text);
...
class thu extends Zubrag_watermark {
