...
if( $mail_sent == 1 ){
echo '<div class="alert-success" role="alert" id="success_message">Success Thanks for contacting us, we will get back to you shortly.</div>';
}
...
<div class='col-md-6'>
<button type='submit' class='btn-send' >Send <span class='glyphicon glyphicon-send'></span></button>
</div>
</div>
</fieldset>
</form>";
